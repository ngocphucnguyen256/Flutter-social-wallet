...
// import 'package:flutter_application/components/custom_image.dart';
// import 'package:flutter_application/models/user.dart';
// import 'package:flutter_application/utils/firebase.dart';
// import 'package:flutter_application/view_models/auth/posts_view_model.dart';
...
//                         ? CustomImage(
//                             imageUrl: (viewModel.imgLink).toString(),
//                             width: MediaQuery.of(context).size.width,
//                             height: MediaQuery.of(context).size.width - 30,
//                             fit: BoxFit.cover,
//                           )
...
//                               )
//                             : (CustomImage(
//                                 imageUrl: (viewModel.mediaUrl).toString(),
//                                 width: MediaQuery.of(context).size.width,
//                                 height: MediaQuery.of(context).size.width - 30,
//                                 fit: BoxFit.cover,
//                               ))
